...
class EmailServiceImpl implements EmailService{
    ...
    EmailServiceImpl(MailSender mailSender, JavaMailSender javaMailSender, SpringTemplateEngine templateEngine, JobRepository jobRepository) {
    ...
    public void sendSimpleEmail() {
        ...
        msg.setTo("vuvip2002z@gmail.com");
        msg.setSubject("Testing");
        msg.setText("Hello viet");
